...
const LaboratorioPage = () => {
  ...
  const handleFullViewClick = (year: string) => {
    router.push(`/armado/budget-view?year=${year}&area=laboratorio`);
  };
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="flex items-center mb-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 mt-1">Presupuesto de Laboratorio</p>
          </div>
        </div>

        {/* Main Content */}
        <div className="bg-gray-50 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-semibold mb-6 text-gray-900">Departamento de Laboratorio 2025</h2>
          ...
          {activeTab === "años-anteriores" && (
            <>
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600 mb-6">Esta sección trata los documentos presupuestarios del Departamento de Laboratorio para el año 2025</p>
            ...
            <>
              ...
              <div className="mb-8">
                ...
                <div className="flex space-x-4">
                  <Link
                    href="/armado/laboratorio/crear-nuevo"
                    className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors duration-200"
                  >
                    Crear Nuevo Presupuesto
                  </Link>
                  <Link
                    href="/armado/laboratorio/editar"
